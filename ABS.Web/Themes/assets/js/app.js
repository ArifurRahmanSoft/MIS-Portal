...
var App = function () {
    ...
    var handleResponsive = function () {
        ...
        $('.toggle-sidebar').click(function (e) {
            ...
            // Toggle class
            $('#container').toggleClass('fixed-header sidebar-closed');
        });
        ...
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) && android_chrome == false) {
            ...
            if ($('#sidebar').hasClass('sidebar-fixed') || $(window).width() <= 767) {
                ...
                if (android_chrome) {
                    ...
                    //my change only comment this $('#sidebar').attr('style', 'position: absolute !important;');
                    ...
                    if ($(window).width() <= 767) {
                        //my change only comment this   $('#sidebar').css('margin-left', '-250px').css('margin-top', '-52px');
                    }
                } else {
                    var wheelStepInt = 7;
                }
