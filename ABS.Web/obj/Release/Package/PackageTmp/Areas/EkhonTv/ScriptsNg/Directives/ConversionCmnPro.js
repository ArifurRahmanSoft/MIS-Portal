...
app.service('conversion', function ($filter, hostDire, $window) {
    ...
    this.getStringToDateDMYY = function (InputString) {
        ...
        var Month = SplitedDate[1];
        var Year = SplitedDate[2];
        var FullFormateDate = Day + "-" + Month + "-" + Year;
        var Output = $filter('date')(new Date(), FullFormateDate);
        return Output;
    }
    ...
    this.getStringToDateMMYYFormat = function (InputString) {
        debugger
        ...
        var Year = SplitedDate[1];
        var FullFormateDate = Month + "-" + 1 + "-" + Year;
        var Output = FullFormateDate;
        return Output;
    }
    ...
    this.getDateToStringMMYYFormat = function (InputDate) {
        var DateToString = InputDate;
        var SplitedDate = DateToString.split("-");
        var Year = SplitedDate[0];
        var Month = SplitedDate[1];
        var Day = SplitedDate[2].split("T");
        var FullFormattedDate = Month + "/" + Day[0] + "/" + Year;
        var Output = $filter('date')(new Date(FullFormattedDate), 'MMMM-yyyy');
        return Output;
    }
    ...
    this.UniformChecked = function (elementid) {
        $('#uniform-' + elementid + '').find('span:first').addClass('checked');
    }
    ...
    var ExcelList = [];
    this.ImportFile_Excel = function (file) {
        ExcelList = [];
        if (file) {
    ...
    this.ProceedImportData = function () {
        return ExcelList;
    }
    ...
    this.cmnParams = function () {
        ...
        cmnParam = {
            ...
            NotiStatus: "Created",
            CompanyShortName: "",
            SaveOrUpdate: UCEntitys.message,
            IsTrue: false,
            IsMail: false,
            IsApproved: false,
            Amount: null,
