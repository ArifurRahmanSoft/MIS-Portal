app.controller('ProductRateCtrl', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        //**************************************************Start Vairiable Initialize**************************************************

        var baseUrl = '/Sales/api/ProductRate/';
        var baseUrl1 = '/Sales/api/ProductsRate/';
        ...
        $scope.loadBrandRecords = function () {
            ...
            var apiRoute = baseUrl1 + 'GetBrand/';
        ...
        //    $scope.ListProductByBrand = []; // make brand list blank first
        //    $scope.ListBrandSkuAdded = []; // make the bottom list blank
        //    var apiRoute = sysCommonUrl + 'GetBulkSKUByBrand/';
