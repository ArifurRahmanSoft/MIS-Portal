app.controller('deliveryStatementConBulkCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.PageTitle = 'Delivery Statement-Consumer & Bulk';
        ...
        frmName = 'frmDelStateConBulk'; DelFunc = 'DeleteDistributorTargetMasterDetail'; DelMsg = 'DistributorTargetNo'; EditFunc = 'loadPIMasterDetailsByActivePI';
        ...
        $scope.ShowReport = function (repType) {
            debugger
            ...
            var queryStringUDS = $scope.StartDate + ',' + $scope.EndDate + ',' + repType;
                        
            var reportPath = repBaseUrl + 'DeliveryStatementConsumerBulk/DeliveryStatementConsumerBulk.aspx?queryString=' + queryStringUDS;
        ...
        $scope.clear = function () {
            $scope.frmDelStateConBulk.$setPristine();
            $scope.frmDelStateConBulk.$setUntouched();
