app.controller('undeliveredStatementOwnProduct', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowUndeliveredStatement = function () {
            ...
            var queryStringUDS = commonQueryString + ',' + $scope.ReportType + ',' + $scope.ngModelBrand + ',' + $scope.ngModelProduct + ',' + $scope.productCompanyId;

            var reportPath = repBaseUrl + 'UndeliveredStatementOwnProduct/UndeliveredStatementOwnProduct.aspx?queryString=' + queryStringUDS;
            conversion.reportOpen(reportPath);
            //$window.open(reportPath);
        };
