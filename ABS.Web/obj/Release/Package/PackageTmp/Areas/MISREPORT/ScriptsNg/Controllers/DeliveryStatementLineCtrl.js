app.controller('DeliveryStatementLineCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowDeliveryStatementLineReport = function () {
            debugger;
            ...
            var reportPath = repBaseUrl + 'DeliveryStatementLineWise/DeliveryStatementLineWise.aspx?queryString=' + queryString;
