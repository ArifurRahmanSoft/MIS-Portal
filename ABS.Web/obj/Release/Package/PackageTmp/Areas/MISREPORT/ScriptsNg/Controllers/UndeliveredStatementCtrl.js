app.controller('undeliveredStatementCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowUndeliveredStatement = function () {
            ...
            var queryStringUDS = commonQueryString + ',' + $scope.ReportType + ',' + $scope.ngModelBrand + ',' + $scope.ngModelProduct + ',' + isBrandGroup + ',' + brandGroupId;
