app.controller('BrandWiseSalesMonthYearLineCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.loadPermissionTypeWiseList = function () {
            $scope.ReportType1 = 'brand';
            $scope.ReportType0 = 'monthly';
            $scope.listSalesLine = [];
            $scope.salesLineId = '';
        ...
        $scope.ReportType0 = 'monthly';
        $scope.ReportType1 = 'brand';
        $scope.ShowBrandWiseSalesMonthYearLineReport = function () {
            debugger;
            ...
            var queryString = $scope.StartDate + ',' + $scope.EndDate + ',' + salesLine + ','
                + salesCompany + ',' + salesCustomerId + ',' + $scope.ReportType + ',' + $scope.ReportType0 + ',' + $scope.ReportType1;

            var reportPath = repBaseUrl + 'BrandWiseSalesMonthYearLine/BrandWiseSalesMonthYearLine.aspx?queryString=' + queryString;
