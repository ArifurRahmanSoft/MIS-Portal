app.controller('SalesStatementNewCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowSalesStatementReport = function () {
            ...
            var queryString = startDate + ',' + endDate + ',' + companyId + ','
                ...
                + ',' + brandId + ',' + productId + ',' + isBrandGroup + ',' + brandGroupId + ',' + reportType;
