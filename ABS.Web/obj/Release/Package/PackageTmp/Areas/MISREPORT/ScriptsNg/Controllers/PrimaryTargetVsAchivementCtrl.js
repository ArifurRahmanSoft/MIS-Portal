app.controller('PrimaryTargetVsAchivementCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowReport = function () {
            ...
            var reportType = mode == '1' ? 'Distributor' : mode == '2' ? 'Zone' : mode == '3' ? 'Region' : mode == '4' ? 'Division' : mode == '5' ? 'National' : '';
            ...
            var queryString = startDate + ',' + endDate + ',' + companyId + ','
                ...
                + ',' + brandId + ',' + productId + ',' + reportType + ',' + mode;

            //var queryString = commonQueryString + ',' + brandId + ',' + productId + ',' + reportType;
            //var queryString = commonQueryString + ',' + reportType;
            var reportPath = repBaseUrl + 'PrimaryTargetVsAchivement/PrimaryTargetVsAchivement.aspx?queryString=' + queryString;
