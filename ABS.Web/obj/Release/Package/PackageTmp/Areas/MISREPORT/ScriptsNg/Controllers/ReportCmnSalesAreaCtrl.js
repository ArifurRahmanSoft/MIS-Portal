app.controller('reportCmnSalesAreaCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowBrandWiseSalesStatement = function (data) {
            ...
            var queryStringBWSS = commonQueryString + ',' + reportOption + ',' + brandId + ',' + productId + ',' + groupId + ',' + isBrandGroup + ',' + brandGroupId;
