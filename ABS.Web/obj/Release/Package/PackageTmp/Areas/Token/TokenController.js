 ...
 * CustomerCtrl.js
 */
app.controller('tokenCtrl', ['$scope', 'hostDire', '$http', '$sessionStorage', '$localStorage', '$rootScope',
    function ($scope, hostDire, $http, tokenService, $sessionStorage, $localStorage, $rootScope) {
        ...
        $scope.menuManager = {
            ...
            LoadPageMenu: function (queryPath) {
                ...
                $.ajax({
                    method: "post",
                    url: hostDire + '/SystemCommon/api/SystemCommonLayout/GetMenuPermission/',
