app.controller('reportCommonCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowBrandWiseSalesStatement = function (data) {
            ...
            if (selectedDivision != '') {
                reportFilter = 'Selected Area: ' + selectedNational + '-' + ' Division: ' + selectedDivision.replace(/[^a-zA-Z0-9]/g, ' ');
            }
            ...
            if (selectedZone != '') {
                reportFilter = 'Selected Area: ' + selectedNational + '-' + ' Division: ' + selectedDivision
                    + '-' + ' Region: ' + selectedRegion + '-' + ' Zone: ' + selectedZone.replace(/[^a-zA-Z0-9]/g, ' ');
            }

            if (selectedDistributor != '') {
                reportFilter = 'Selected Area: ' + selectedNational + '-' + ' Division: ' + selectedDivision
                    + '-' + ' Region: ' + selectedRegion + '-' + ' Zone: ' + selectedZone + '-' + ' Distributor: ' + selectedDistributor.replace(/[^a-zA-Z0-9]/g, ' ');
            }
        ...
        $scope.ShowDeliveryStatement = function () {
            ...
            var queryStringUDS = commonQueryString + ',' + $scope.ngModelBrand + ',' + $scope.ngModelProduct + ','
                + $scope.ngModelCompany + ',' + $scope.ngModelLocation + ',' + $scope.ReportType;
        ...
        $scope.ShowDistributorAutomationReport = function () {
            ...
            var reportPath = repBaseUrl + 'DistributorAutomation/DistributorAutomation.aspx?queryString=' + queryString;
            conversion.reportOpen(reportPath);
        };
