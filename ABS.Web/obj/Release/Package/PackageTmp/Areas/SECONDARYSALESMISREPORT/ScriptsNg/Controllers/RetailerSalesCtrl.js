app.controller('RetailerSalesCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        frmName = 'frmRetailerSales'; DelFunc = 'DeleteDistributorTargetMasterDetail'; DelMsg = 'DistributorTargetNo'; EditFunc = 'loadPIMasterDetailsByActivePI';
        ...
        $scope.ShowReport = function () {
            ...
            var reportPath = repBaseUrl + 'RetailerSales/RetailerSales.aspx?queryString=' + queryString;
            conversion.reportOpen(reportPath);
            //$window.open(reportPath);
        };

        $scope.ReportType = 'SR_Delivery_Detail_Dist';
