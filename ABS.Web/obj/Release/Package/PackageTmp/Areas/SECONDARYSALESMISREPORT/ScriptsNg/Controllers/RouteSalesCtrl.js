app.controller('RouteSalesCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        frmName = 'frmRouteSales'; DelFunc = 'DeleteDistributorTargetMasterDetail'; DelMsg = 'DistributorTargetNo'; EditFunc = 'loadPIMasterDetailsByActivePI';
        ...
        $scope.ShowReport = function () {
            ...
            var reportPath = repBaseUrl + 'RouteSales/RouteSales.aspx?queryString=' + queryString;
