...
app.service('crudService', function ($http, hostDire, conversion, $q) {
    ...
    this.getAreaWiseSalesPerson = function (apiRoute, national, division, region, zone, distributor, page, pageSize, isPaging, headerToken) {
        debugger
        apiRoute = hostDire + apiRoute;
        urlGet = apiRoute + national + '/' + division + '/' + region + '/' + zone + '/' + distributor + '/' + page + '/' + pageSize + '/' + isPaging;
        var request = $http({
            method: "get",
            url: urlGet,
            headers: headerToken
