...
app.controller('SideMenuBarCtl', ['$scope', 'hostDire', 'sideNavService', '$localStorage', '$rootScope',
    function ($scope, hostDire, sideNavService, $localStorage, $rootScope) {
        ...
        //    var apiRoute = hostDire+'/MISREPORT/api/MISReportLayout/GetSideMenu/';
        ...
        function loadRecords_Menues(dataModuleID) {
            ...
            var companyID = $scope.sessionUserCompanyID;
            var loggedUser = $scope.sessionLoggedUserID;
            var apiRoute = '/MISREPORT/api/MISReportLayout/GetSideMenu/';
            $scope.loaderWait = true;
            $scope.LoadMessage = 'Loading Please wait...!';
