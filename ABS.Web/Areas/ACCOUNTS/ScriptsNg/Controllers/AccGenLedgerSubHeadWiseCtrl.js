app.controller('AccGenLedgerSubHeadWiseCtrl', ['$scope', '$http', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants', 'hostDire',
    function ($scope, $http, crudService, conversion, $filter, $localStorage, uiGridConstants, hostDire) {
        ...
        frmName = 'frmAccGenLedgerSubHeadWise'; DelFunc = 'DeleteAccGenLedgerSubHeadWise'; DelMsg = 'IncentiveFormulaSetupNo'; EditFunc = 'loadPIMasterDetailsByActivePI';
        ...
        $scope.ShowReport = function () {
            ...
            var reportPath = '/Areas/ACCOUNTS/Reports/GeneralLedgerSubHeadWise/GeneralLedgerSubHeadWise.aspx?queryString=' + queryStringUDS;
