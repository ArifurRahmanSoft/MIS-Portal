...
{
    public partial class CostingComparison : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LocalReport.ReportPath = Server.MapPath("~/Areas/COSTING/Reports/CostingComparison/CostingComparisonRdlc.rdlc");

                OracleCommand objCmd = new OracleCommand();
               
                objCmd.CommandText = "COSTING.COSTING_COMPARISON";
                ...
                ReportDataSource datasource = new ReportDataSource("DDS_CostingComparison", dt);
