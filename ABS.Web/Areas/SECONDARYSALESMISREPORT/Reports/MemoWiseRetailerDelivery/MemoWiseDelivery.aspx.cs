...
{
    public partial class MemoWiseDelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string autoId = reportActivityMonitoring.RequestStart("Memo-wise Delivery", reportFilteringData, Session["UserID"].ToString(), Session["UserFullName"].ToString());
                ...
                if(report_Type == "MemoWise")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/MemoWiseRetailerDelivery/MemoWiseRetailerDelivery.rdlc");
                }
                if (report_Type == "BrandWise")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/MemoWiseRetailerDelivery/BrandWiseRetailerDelivery.rdlc");
                }

                objCmd.CommandText = "PKG_REPORT_RETAILER.GET_RETAILER_DLV";
                ...
                ReportDataSource datasource = new ReportDataSource("DSMemoWiseDelivery", dt);
