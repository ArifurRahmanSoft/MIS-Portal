    ...
    public partial class TargetVSAchievement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //objCmd.CommandText = "PKG_Report_Target_VS_Ach.GET_TARGET_VS_ACH_SO_WISE";
                //if(fromDate)
                //objCmd.CommandText = "PKG_Report_Target_VS_Ach_New.GET_TARGET_VS_ACH_SO_WISE";
                objCmd.CommandText = "PKG_Report_Target_VS_Ach_New.GET_TARGET_VS_ACH_SO_WISE_NEW";

                if (reporttype == "Summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/TargetVSAchievementSOWise/SummaryTargetVSAchievementSOWiseNew.rdlc");
                }
                if (reporttype == "Detail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/TargetVSAchievementSOWise/DetailTargetVSAchievementSOWiseNew.rdlc");
                }
                ...
                ReportDataSource datasource = new ReportDataSource("DTTargetVSAchievement", dt);
