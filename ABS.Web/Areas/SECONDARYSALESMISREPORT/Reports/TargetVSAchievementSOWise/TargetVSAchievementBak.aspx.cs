...
{
    public partial class TargetVSAchievementBak : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/TargetVSAchievementSOWise/SummaryTargetVSAchievementSOWise.rdlc");
                }
                if (reporttype == "Detail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/TargetVSAchievementSOWise/DetailTargetVSAchievementSOWise.rdlc");
                }
