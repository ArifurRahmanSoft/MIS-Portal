...
{
    public partial class StockOrderDelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string autoId = reportActivityMonitoring.RequestStart("Stock Order Delivery", reportFilteringData, Session["UserID"].ToString(), Session["UserFullName"].ToString());
                ...
                objCmd.CommandText = "PKG_REPORT_STK_ORD_DLV_NEW.GET_STK_ORD_DLV";


                if (reporttype == "CtnSackParty")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryCtnParty.rdlc");
                }
                if (reporttype == "CtnSackZone")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryCtnZone.rdlc");
                }
                if (reporttype == "PcsParty")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryPcsParty.rdlc");
                }
                if (reporttype == "PcsZone")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryPcsZone.rdlc");
                }
                if (reporttype == "SkuParty")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliverySkuParty.rdlc");
                }
                if (reporttype == "SkuZone")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliverySkuZone.rdlc");
                }
                if (reporttype == "CtnSkuParty")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryCtnSkuParty.rdlc");
                }
                if (reporttype == "CtnSkuZone")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryCtnSkuZone.rdlc");
                }
                if (reporttype == "MtParty")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryMtParty.rdlc");
                }
                if (reporttype == "MtZone")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/StockOrderDelivery/StockOrderDeliveryMtZone.rdlc");
                }
                ...
                ReportDataSource datasource = new ReportDataSource("DSStockOrderDelivery", dt);
