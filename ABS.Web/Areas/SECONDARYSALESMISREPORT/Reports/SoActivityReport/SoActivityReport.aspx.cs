...
{
    public partial class SoActivityReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (iid == "2" )
                {
                    ...
                    if (arrangeType == "2")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SoActivityReport/DIVISION_ActivityReport.rdlc");
                    }

                    if (arrangeType == "3")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SoActivityReport/REGION_ActivityReport.rdlc");
                    }


                    if (arrangeType == "4")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SoActivityReport/ZONE_ActivityReport.rdlc");
                    }

                    if (arrangeType == "5")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SoActivityReport/DIST_ActivityReport.rdlc");
                    }

                    if (arrangeType == "6")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SoActivityReport/SOActivityReport.rdlc");
                    }

                    OracleCommand objCmd = new OracleCommand();
                    objCmd.CommandText = "PKG_ACTIVITY_REPORT_SO.getOrderActivitySummary";
