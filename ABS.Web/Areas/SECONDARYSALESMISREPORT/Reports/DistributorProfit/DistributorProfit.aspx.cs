...
namespace ABS.Web.Areas.SECONDARYSALESMISREPORT.Reports.DistributorProfit
{
    public partial class DistributorProfit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string autoId = reportActivityMonitoring.RequestStart("Distributor Profit", reportFilteringData, Session["UserID"].ToString(), Session["UserFullName"].ToString());
                ...
                LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/DistributorProfit/DistributorProfit.rdlc");
                objCmd.CommandText = "DistributorProfit.getDistributorProfit";
                ...
                ReportDataSource datasource = new ReportDataSource("DistributorProfit", dt);
