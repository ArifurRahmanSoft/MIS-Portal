...
{
    public partial class SRPerformanceMonitoringBak : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    p5.Values.Add("Value");
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SO_PERFORMANCE";
                ...
                else if (reporttype == "SR_Delivery_Summary")
                {
                    ...
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_DELIVERY_SUMMARY";
                    ...
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_DELIVERY_DETAIL";
                ...
                else if (reporttype == "SR_Delivery_Detail_Sku")
                {
                    ...
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_DELIVERY_SKU_WISE";
                ...
                else if (reporttype == "SR_Delivery_Detail_Dist")
                {
                    ...
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_DELIVERY_DIST_WISE";
                ...
                else if (reporttype == "SR_Order_Summary")
                {
                    ...
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_ORDER_SUMMARY";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SRPerformance/SRPerformanceMonitoringSummary.rdlc");
                }
                else if (reporttype == "SR_Order_Detail")
                {
                    p5.Values.Add("Order-Detail");
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_ORDER_DETAIL";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SRPerformance/SRPerformanceMonitoringDetail.rdlc");
                }
                else if (reporttype == "SR_Order_Detail_Sku")
                {
                    p5.Values.Add("Order-SKU-Wise");
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_ORDER_SKU_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SRPerformance/SRPerformanceMonitoringDetailSkuWise.rdlc");
                }
                else if (reporttype == "SR_Order_Detail_Dist")
                {
                    p5.Values.Add("Order-Dist-Wise");
                    objCmd.CommandText = "PKG_Report_Sales_Officer_Performance.GET_SR_PERFORMANCE_ORDER_DIST_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/SRPerformance/SRPerformanceMonitoringDetailDistWise.rdlc");
                }
