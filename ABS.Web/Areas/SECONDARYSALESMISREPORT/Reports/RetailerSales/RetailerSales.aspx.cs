...
{
    public partial class RetailerSales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string pkgName = "PKG_Report_RetailerSales";
                string spName = "";
                if (reporttype == "SR_Delivery_Detail_Dist")
                {
                    p5.Values.Add("Delivery");
                    spName = "GET_RETAILERSALES_DELIVERY_RETAILER_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/RetailerSales/RetailerSalesDetailDistWise.rdlc");
                }
                else if (reporttype == "SR_Order_Detail_Dist")
                {
                    p5.Values.Add("Order");
                    spName = "GET_RETAILERSALES_ORDER_RETAILER_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/RetailerSales/RetailerSalesDetailDistWise.rdlc");
                }
                ...
                ReportDataSource datasource = new ReportDataSource("DTRetailerSales", dt);
