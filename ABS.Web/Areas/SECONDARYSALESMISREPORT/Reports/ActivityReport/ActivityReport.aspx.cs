...
namespace ABS.Web.Areas.SECONDARYSALESMISREPORT.Reports.ActivityReport
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (iid == "2" )
                {
                    ...
                    if (arrangeType == "2")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/ActivityReport/DIVISION_ActivityReport.rdlc");
                    }

                    if (arrangeType == "3")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/ActivityReport/REGION_ActivityReport.rdlc");
                    }


                    if (arrangeType == "4")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/ActivityReport/ZONE_ActivityReport.rdlc");
                    }

                    if (arrangeType == "5")
                    {
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/ActivityReport/DIST_ActivityReport.rdlc");
                    }
                    ...
                    objCmd.CommandText = "PKG_ACTIVITY_REPORT.getSSActivity";
                    objCmd.CommandType = CommandType.StoredProcedure;
                    objCmd.Parameters.Add("p_cursor", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
                    objCmd.Parameters.Add("p_mode", OracleDbType.Varchar2).Value = "1"; //arrangeType=="6"?"1":"2";
                    ...
                    DataTable dt = classDt.GetCssapData(objCmd);
