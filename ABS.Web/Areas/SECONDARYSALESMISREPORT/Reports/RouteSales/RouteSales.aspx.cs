...
namespace ABS.Web.Areas.SECONDARYSALESMISREPORT.Reports.RouteSales
{
    public partial class RouteSales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string pkgName = "PKG_Report_RouteSales";
                string spName = "";
                if (reporttype == "SR_Delivery_Detail_Dist")
                {
                    p5.Values.Add("Delivery");
                    spName = "GET_ROUTESALES_DELIVERY_ROUTE_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/RouteSales/RouteSalesDetailDistWise.rdlc");
                }
                else if (reporttype == "SR_Order_Detail_Dist")
                {
                    p5.Values.Add("Order");
                    spName = "GET_ROUTESALES_ORDER_ROUTE_WISE";
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SECONDARYSALESMISREPORT/Reports/RouteSales/RouteSalesDetailDistWise.rdlc");
                }
                ...
                ReportDataSource datasource = new ReportDataSource("DTRouteSales", dt);
