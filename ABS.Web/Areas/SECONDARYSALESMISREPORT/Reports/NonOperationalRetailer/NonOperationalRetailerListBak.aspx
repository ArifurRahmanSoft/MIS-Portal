<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NonOperationalRetailerListBak.aspx.cs" 
    Inherits="CGSS.Web.Areas.Reports.OrderDeliveryByBrand.NonOperationalRetailerBak" %>
...
<body>
    <form id="form1" runat="server" style="width:100%; height:100%;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="" ClientIDMode="AutoID" 
            ...
            Height="100%" Width="100%" AsyncRendering="False" SizeToReportContent="True" PageCountMode="Actual">
