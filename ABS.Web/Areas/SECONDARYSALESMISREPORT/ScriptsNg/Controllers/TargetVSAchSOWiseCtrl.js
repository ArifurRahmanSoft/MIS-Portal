app.controller('targetVSAchSOWiseCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowStockOrderDeliveryReport = function () {
            ...
            var queryString = commonQueryString + ',' + $scope.ngModelBrand + ',' + $scope.ngModelProduct + ',' + isBrandGroup + ',' + brandGroupId + ',' + reporttype;
        ...
        $scope.ShowTargetVSAchievementSOWise = function () {
            ...
            var reporttype = $scope.ReportType;
            var queryString = commonQueryString + ',' + $scope.ngModelSalesPerson + ',' + $scope.ngModelBrand + ',' + $scope.ngModelProduct + ',' + isBrandGroup + ',' + brandGroupId + ',' + reporttype;
