app.controller('retailerInformationCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        frmName = 'frmRetailerInformationReport'; DelFunc = 'DeleteDistributorTargetMasterDetail'; DelMsg = 'DistributorTargetNo'; EditFunc = 'loadPIMasterDetailsByActivePI';
        ...
        $scope.OperationalRetailerCount = function (data) {
            ...
            var queryString = startDate + ',' + endDate + ',' + nationalId + ','
                + divisionId + ',' + regionId + ',' + zoneId + ',' + distributorId + ',' + salesPersonId + ','
                + routeId + ',' + reportFilter + ',' + data + ',' + $scope.ReportType;
        ...
        $scope.DistributorStockDayEndDelivery = function () {
            ...
            var queryString = commonQueryString;
            var reportPath = repBaseUrl + 'RetailerInformation/RetailerInfo.aspx?queryString=' + queryString;
            conversion.reportOpen(reportPath);
        };
