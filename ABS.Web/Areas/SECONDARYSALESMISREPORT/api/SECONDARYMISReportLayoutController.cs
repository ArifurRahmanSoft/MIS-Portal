...
{
    [RoutePrefix("SECONDARYSALESMISREPORT/api/SECONDARYMISReportLayout")]
    public class SECONDARYMISReportLayoutController : ApiController
    {
        private iMenuMgt objService = null;

        public SECONDARYMISReportLayoutController()
        {
