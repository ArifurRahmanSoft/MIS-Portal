...
app.controller('menuCtrl', ['$scope', '$localStorage', 'menuService', '$rootScope', '$http', function ($scope, $localStorage, menuService, $rootScope, $http) {
    ...
    // debugger
    var baseUrl = '/SystemCommon/api/Menu/';
    ...
    function loadRecords_Menues(isPaging, modID) {
        var moduleID = modID;
        var apiRoute = sysCommonUrl + 'GetParentMenuForDropDown/';
    ...
    $scope.getMenuForEdit = function (dataModel) {
        ...
        var apiRoute = baseUrl + 'GetMenuByID/' + dataModel.MenuID;
    ...
    $scope.save = function () {
        ...
        if (isExisting === 0) {
            ...
            var apiRoute = baseUrl + 'UpdateMenu/';
    ...
    $scope.delete = function (dataModel) {
        ...
        if (IsConf) {
            var apiRoute = baseUrl + 'DeleteMenu/' + dataModel.MenuID;
