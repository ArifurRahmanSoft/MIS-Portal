app.controller('PrimaryVsSecondaryCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowReport = function () {
            ...
            var reportPath = repBaseUrl + 'PrimaryVsSecondary/PrimaryVsSecondary.aspx?queryString=' + queryStringPTR;
