...
namespace ABS.Web.Areas.SPECIALREPORT.Reports.DeliveryStatement
{
    public partial class DeliveryStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementCustomerWiseDetials.rdlc");
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_challanDetail.get_challanDetail";
                    }
                }
                if (reportType == "sku_wise")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementSKUWise.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_challanDetail.get_SKUWiseDelivery";
                    }
                }
                if (reportType == "summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementAreaSummary.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "pack_challanDetail.DeliveryAreaWise";
                    }
                }
                if (reportType == "summaryton")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementAreaSummaryTon.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementAreaDetailNew.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_challanDetail_BCT.DeliveryAreaWise";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/DeliveryStatement/ReportDeliveryStatementAreaDetailTon.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_challanDetail_BCT.DeliveryAreaWiseMTon";
                    }
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_challanDetail.DeliveryAreaWiseMTon";
                    }
                }
