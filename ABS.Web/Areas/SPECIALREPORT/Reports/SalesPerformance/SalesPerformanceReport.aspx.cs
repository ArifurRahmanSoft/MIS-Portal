            ...
            if (!IsPostBack)
            {
                ...
                if (reportOption == "mto")
                {
                    if (reportType == "1")   // Summary Report
                    {
                        ...
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummaryMTon.rdlc");
                        ...
                        {
                            objCmd.CommandText = "SPCL_SALES_PERFOR_AREA.AREA_SUMMARY";
                        }
                    }
                    else     // detail report
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailMTon.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                        ...
                        {
                            objCmd.CommandText = "SPCL_SALES_PERFOR_AREA.AREA_DETAIL";
                        }
                    }
                }
                ...
                if (reportOption == "mtoWithFree")
                {
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Summary");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummaryMTonWithFree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailMTonWithFree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                ...
                if (reportOption == "ctn_sack")
                {
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Summary");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummaryCtnSack.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_SUMMARY";
                        }
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailCtnSack.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_DETAIL";
                        }
                ...
                if (reportOption == "ctn_sack_With_Free") 
                {
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Summary");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummaryCtnSackWithFree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_SUMMARY_FREE_PCS";
                        }
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailCtnSackWithFree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_DETAIL_FREE_PCS";
                        }
                ...
                if (reportOption == "sku") 
                {
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Summary");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummarySKU.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_SUMMARY";
                        }
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailSKU.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_DETAIL";
                        }
                ...
                if (reportOption == "SkuWithFree")
                {
                    if (reportType == "1")   // Summary Report
                    {
                        autoId = WritingReportStartActivity("Sales Performance Summary");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceSummarySKUfree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_SUMMARY_FREE_PCS";
                        }
                    ...
                    {
                        autoId = WritingReportStartActivity("Sales Performance Detail");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesPerformance/New_SalesPerformanceDetailSKUFree.rdlc");
                        if (UserId == "07686") // tea - Iqbal Chowdhury
                        {
                            objCmd.CommandText = "SALES_PERFOR_AREA_BCT.AREA_DETAIL_FREE_PCS";
                        }
