<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesPerformanceReport.aspx.cs" 
    Inherits="ABS.Web.Areas.SPECIALREPORT.Reports.SalesPerformance.SalesPerformanceReport" %>
...
<body>
    ...
    <form id="form1" runat="server" style="width:100%; height:100%;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="" ClientIDMode="AutoID" HighlightBackgroundColor="" InternalBorderColor="204, 204, 204" InternalBorderStyle="Solid" InternalBorderWidth="1px" LinkActiveColor="" LinkActiveHoverColor="" LinkDisabledColor="" PrimaryButtonBackgroundColor="" PrimaryButtonForegroundColor="" PrimaryButtonHoverBackgroundColor="" 
            ...
            AsyncRendering="False" SizeToReportContent="True" PageCountMode="Actual">          
