    ...
    public partial class BrandWiseSalesMonthYear : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string reportData = queryStrings[9];
                ...
                if (reportType == "1")
                {
                    if (reportData == "brand")
                    {
                        ...
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesMonth_Brand.rdlc");
                    }
                    else
                    {
                        autoId = WritingReportStartActivity("SKU-Wise Sales Month");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesMonth_SKU.rdlc");
                    }
                }
                if (reportType == "2")
                {
                    if (reportData == "brand")
                    {
                        ...
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesYear_Brand.rdlc");
                    }
                    else
                    {
                        autoId = WritingReportStartActivity("SKU-Wise Sales Year");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesYear_SKU.rdlc");
                    }       
                }
                if (reportType == "3")
                {
                    if (reportData == "brand")
                    {
                        ...
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesDaily_Brand.rdlc");
                    }
                    else
                    {
                        autoId = WritingReportStartActivity("SKU-Wise Sales Daily");
                        LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/BrandWiseSalesMonthYear/BrandWiseSalesDaily_SKU.rdlc");
                    }     
                }
                ...
                {
                    objCmd.CommandText = "SPCL_SALES_VARIATIONS.BrandwiseSalesMonthYear_FA";
                }
                else
                {
                    objCmd.CommandText = "SPCL_SALES_VARIATIONS.BrandwiseSalesMonthYear";
                }
