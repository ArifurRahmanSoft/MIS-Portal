...
namespace ABS.Web.Areas.SPECIALREPORT.Reports.SalesStatement
{
    public partial class SalesStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/DetailsSalesStatementRDLC.rdlc");
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_sales_state2.SALES_STATEMENT";
                    }
                }
                if (reportType == "summary_sales_statement")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/SummarySalesStatementRDLC.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_sales_state2_bct.SALES_STATEMENT";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/ItemWiseSummaryRDLC.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_sales_state2.sales_statement_item_wise_summary";
                    }
                }
                if (reportType == "party_wise_qnty_summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/PartyWiseQntySummaryRDLC.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_sales_state2_bct.SALES_STATEMENT";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/PartyWiseSummaryRDLC.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_sales_state2_bct.SALES_STATEMENT";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/SPECIALREPORT/Reports/SalesStatement/SalesStatementTonRDLC.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "spcl_pack_sales_state2.SALES_STATEMENT_WITH_TON";
                    }
                }
