...
namespace CTGroup.Web.Areas.SHOWROOM.api
{
    [RoutePrefix("SHOWROOM/api/ShowRoomLayout")]
    public class ShowRoomLayoutController : ApiController
    {
        private iMenuMgt objService = null;

        public ShowRoomLayoutController()
        {
