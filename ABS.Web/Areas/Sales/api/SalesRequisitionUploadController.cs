...
{
    [RoutePrefix("Sales/api/SalesRequisitionUpload")]
    public class SalesRequisitionUploadController : ApiController
    {
        private iSalesRequisitionUpload _objDocumentService = null;

        public static DateTime startDate, endDate;
        public static string LoggedUser;

        public SalesRequisitionUploadController()
        {
            _objDocumentService = new SalesRequisitionUploadMgt();
        }       
        ...
        public dynamic UploadDocuments()
        {
            ...
            List<vmSalesRequisitionUpload> objvmAutoRiceSalesUpload = null;
                ...
                for (int i = 0; i < totalfile; i++)
                {
                    ...
                    if (hpf.ContentLength > 0)
                    {
                        if (!File.Exists(sPath + Path.GetFileName(hpf.FileName)))
                        {
                            ...
                            objvmAutoRiceSalesUpload = ConvertDataTableToGenericList.AutoRiceSalesUploadLists<vmSalesRequisitionUpload>(dt);
        ...
        public string InsertDocumentList(object[] data)
        {
            ...
            foreach (vmDocuments doc in Documents)
            {
                ...
                objDocument.DocumentPathID = 5; // this values comes from database.
                objDocument.TransactionTypeName = "SalesRequisitionUpload";
            ...
            try
            {
                using (objCmd.Connection = con)
                {
                    ...
                    objCmd.CommandText = "SALESREQUISITIONUPLOAD.SET_CmnDocument";
