app.controller('IncentiveRateSetupCtrl', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.PageTitle = 'Incentive Rate Setup';
        ...
        $scope.ListTitlePIDeatails = 'Listed Item of Incentive Distribution Ratio';
        ...
        $scope.Save = function () {
            ...
            var apiRoute = baseUrl + 'SaveUpdateIncentiveRateSetup/';
            var IncentiveFormulaSaveUpdate = crudService.postModels(apiRoute, incentiveRate, $scope.ListIncentiveDistRatio);
            IncentiveFormulaSaveUpdate.then(function (response) {
                var result = 0;
                //message = $scope.IncentiveFormulaSetupID == 0 ? 'Saved' : 'Updated';
                if (response != "") {
                    $scope.clear();
                    $scope.IncentiveRateID = response;
        ...
        $scope.clear = function () {
            $scope.frmIncentiveRate.$setPristine();
            $scope.frmIncentiveRate.$setUntouched();

            $scope.ngPerQuantity = '';
            $scope.ngIncentiveAmount = '';

            $scope.IsCreateIcon = false;
            $scope.IsListIcon = true;

            $scope.IncentiveRateID = '0';
            $scope.showDtgrid = 0;
            ...
            $scope.listBrand = [];
            $scope.ngModelBrandForRate = '';
            $("#ddlBrand").select2("data", { id: '', text: '--Select Brand--' });
