app.controller('IncentiveFormulaSetupCtrl', ['$scope', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.PageTitle = 'Incentive Formula Setup';
        ...
        $scope.Save = function () {
            ...
            var itemMaster = {
                ...
                CREATED_BY: objcmnParam.loggeduser
            };
            ...
            var apiRoute = baseUrl + 'SaveUpdateIncentiveFormulaSetup/';
