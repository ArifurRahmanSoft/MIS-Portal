...
app.controller('DailyClosingCtrl', ['$scope', 'crudService', 'uiGridConstants', '$q', '$http', 'conversion', '$filter', '$localStorage',
    function ($scope, crudService, uiGridConstants, $q, $http, conversion, $filter, $localStorage) {

        var baseUrl = "/Sales/api/DailyClosing/";
        ...
        $scope.PageTitle = 'Bulk Daily Closing';
        $scope.ListTitle = 'Bulk Daily Closing';

        $scope.PageTitle = 'Bulk Daily Closing';
        $scope.ListTitle = 'Bulk Daily Closing';
        $scope.ListTitleMrrMasters = 'Bulk Daily Closing';
        ...
        function loadMotherVesselMasterRecords(isPaging) {
            ...
            $scope.gridOptionATRS = {
                columnDefs: [
                    ...
                    { name: "CLOSINGBALANCE", displayName: "CLOSING BALANCE", title: "CLOSING BALANCE", width: '25%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "SALEDATE", displayName: "BALANCE DATE", title: "BALANCE DATE", width: '25%', cellFilter: 'date:"dd-MM-yyyy"', headerCellClass: $scope.highlightFilteredHeader },
                    {
                        name: 'Action',
                        displayName: "Action",
                        pinnedRight: true,
            ...
            var apiRoute = baseUrl + 'GetDailyClosing/';
            ...
            Collector =
                {
                    ...
                    OID: $scope.OID,
                BULKDAILYCLOSINGBALANCE: $scope.BULKDAILYCLOSINGBALANCE,
                    SALETYPE: $scope.saletype,
                    LOCATIONOID: $scope.LOCATIONOID
                };
            var apiRoute = baseUrl + 'SaveDailyClosing/';
