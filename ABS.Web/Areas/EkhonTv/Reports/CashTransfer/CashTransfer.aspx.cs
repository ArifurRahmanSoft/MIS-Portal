...
namespace CTGroup.Web.Areas.Expense.Reports.CashTransfer
{
    public partial class CashTransfer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "cash_transfer_Details")
                { 
                  LocalReport.ReportPath = Server.MapPath("~/Areas/EkhonTv/Reports/CashTransfer/CashTransferReportDetails.rdlc");
                }
                if (reportType == "cash_transfer_Summary")
                {
                  LocalReport.ReportPath = Server.MapPath("~/Areas/EkhonTv/Reports/CashTransfer/CashTransferSummary.rdlc");
                }
                OracleCommand objCmd = new OracleCommand();

                objCmd.CommandText = "Rpt_tv_client_ledger.getdata_cash_rcv";
                ...
                objCmd.Parameters.Add("sel4", OracleDbType.Varchar2).Value = to_date;
                ...
                ReportDataSource datasource = new ReportDataSource("DSCASHTRANSFER", dt);
                ...
                ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p2, p3 });
            }
        }
    }
}