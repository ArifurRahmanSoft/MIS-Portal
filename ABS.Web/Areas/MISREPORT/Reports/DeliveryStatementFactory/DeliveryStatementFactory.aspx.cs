...
{
    public partial class DeliveryStatementFactory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "itemgroup")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryItemGroupWise.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "partydetail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryPartyDetails.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "partysummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryPartySummary.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
              
                if (reportType == "itemdetails")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryItemDetails.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "itemsummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryItemSummary.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "perioditem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryDetailsPeriodWise.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "periodsummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactorySummaryPeriodWise.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
                if (reportType == "pointitem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementFactory/DeliveryStatementFactoryDetailsPointWise.rdlc");
                    objCmd.CommandText = "PKG_RPT_DEL_FACTORY.M_HASAN_DEL_FACTORY";
                }
          ...
          //    objCmd.Parameters.Add("transportID", OracleDbType.Varchar2).Value = transportID;
            ...
            //  objCmd.Parameters.Add("reportType", OracleDbType.Varchar2).Value = reportType;
                ...
                ReportDataSource datasource = new ReportDataSource("DSFactoryDeliveryConsumer", dt);
