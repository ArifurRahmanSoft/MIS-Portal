...
namespace ABS.Web.Areas.MISREPORT.Reports.RupshiFoodsDelivery
{
    public partial class RupshiFoodsDelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsDelivery/RupshiFoodsDeliveryDetials.rdlc");
                }
                if (reportType == "sku")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsDelivery/RupshiFoodsDeliverySKUWise.rdlc");
                }
                if (reportType == "details")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsDelivery/RupshiFoodsDeliverySKUWiseDetails.rdlc");
                }

                objCmd.CommandText = "RUP_FOOD_SAL_DEL_UNDEL.RUP_FOOD_DELI";
