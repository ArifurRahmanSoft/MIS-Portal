<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributorInvoiceBak.aspx.cs" Inherits="ABS.Web.Areas.MISREPORT.Reports.DistributorInvoice.DistributorInvoiceBak" %>
...
<body>
    <form id="form1" runat="server" style="width:100%; height:100%;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="" ClientIDMode="AutoID" HighlightBackgroundColor="" 
            ...
            LinkActiveHoverColor="" LinkDisabledColor="" PrimaryButtonBackgroundColor="" PrimaryButtonForegroundColor="" 
            PrimaryButtonHoverBackgroundColor="" PrimaryButtonHoverForegroundColor="" SecondaryButtonBackgroundColor="" 
            ...
            ToolBarItemPressedHoverBackColor="153, 187, 226" Height="100%" Width="100%" AsyncRendering="False" 
