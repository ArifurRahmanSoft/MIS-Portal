    ...
    public partial class DistributorInvoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string requisitionID = queryStrings[0];
                string isBrndGroup = queryStrings[1];
                string brndGroupId = queryStrings[2];
                ...
                objCmd.CommandText = "REPORTS.Distributor_Invoice_New";
