...
{
    public partial class ExportConsumerDeliveryFactory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerDeliveryFactory/ReportDeliveryStatementCustomerWiseDetialsFactory.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_DELI";
                }
                if (reportType == "sku")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerDeliveryFactory/ReportDeliveryStatementSKUWiseFactory.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_DELI";
                }
