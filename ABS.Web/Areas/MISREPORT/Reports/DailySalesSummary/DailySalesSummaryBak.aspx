<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailySalesSummaryBak.aspx.cs" 
    Inherits="ABS.Web.Areas.MISREPORT.Reports.DailySalesSummary.DailySalesSummaryBak" %>
...
<head runat="server">
    ...
    <title>Daily Sales Summary | MIS Report</title>
</head>
...
<body>       
    <form id="form1" runat="server" style="width:100%; height:100%;">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" HyperlinkTarget="_blank" BackColor="" ClientIDMode="AutoID" 
