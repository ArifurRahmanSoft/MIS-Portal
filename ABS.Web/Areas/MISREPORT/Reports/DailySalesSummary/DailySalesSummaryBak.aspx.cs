...
{
    public partial class DailySalesSummaryBak : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "reqbased")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.DAILY_SALES_SUMMARY_REQ_BASED";
                    }
                }
                ...
                if (reportType == "reqbased_bulk")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.DAILY_SALES_SUMMARY_REQ_BASED_BULK";
                    }
                }
                ...
                if (reportType == "dobased")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.DAILY_SALES_SUMMARY_DO_BASED";
                    }
                }
                ...
                if (reportType == "dobased_bulk")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.DAILY_SALES_SUMMARY_DO_BASED_BULK";
                    }
                }
                ...
                if (reportType == "pack_size_wise_daily_sels")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.PACK_SIZE_WISE_DAILY_SALES";
                    }
                }
                if (reportType == "daily_sales_consumer_with_bulk")
                {
                    ...
                    {
                        objCmd.CommandText = "DAILY_SALES_SUMMARY.cash_daily_sales";
                    }
                }
