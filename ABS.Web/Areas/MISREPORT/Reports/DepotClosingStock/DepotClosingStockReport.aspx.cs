...
{
    public partial class DepotClosingStockReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "Daily")
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DepotClosingStock/DepotClosingStock.rdlc");

                if (reportType == "Summary")
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DepotClosingStock/DepotClosingStock.rdlc");


                objCmd.CommandText = "DEPOSTOCK.getdata_depot_new";
                ...
                objCmd.Parameters.Add("p_Company", OracleDbType.Varchar2).Value = companyID; // M.Hasan
                ...
                ReportDataSource datasource = new ReportDataSource("DTDepotClosingStock", dt);
