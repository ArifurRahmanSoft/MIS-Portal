...
namespace ABS.Web.Areas.MISREPORT.Reports.UndeliveredStatementOwnProduct
{
    public partial class UndeliveredStatementOwnProduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string prodComId = queryStrings[11];
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUSDetails.rdlc");
                    ...
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_PRODCOM.summary_detail";
                    }
                }
                if (reportType == "summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatement.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.summary_detail";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementXParty.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_PRODCOM.PARTY_X_PRODUCT";
                    }
                }
                if (reportType == "partyxproductxbrand")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementXPartyByBrand.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.PARTY_X_PRODUCT";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementAreaWise.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_PRODCOM.UNDELI_AREA_WIESE";
                    }
                }
                if (reportType == "areadetail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementAreaWiseDetail.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.UNDELI_AREA_WIESE";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementAreaWiseTon.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.UNDELI_AREA_WIESE";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementOwnProduct/ReportUndeliveredStatementAreaWiseDetailTon.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.UNDELI_AREA_WIESE";
                    }
