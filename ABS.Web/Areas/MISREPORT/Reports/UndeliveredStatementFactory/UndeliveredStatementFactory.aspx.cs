...
{
    public partial class UndeliveredStatementFactory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementFactory/ReportUSDetailsFactory.rdlc");
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementFactory/ReportUndeliveredStatementFactory.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.summary_detail";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementFactory/ReportUndeliveredStatementFactoryXParty.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/UndeliveredStatementFactory/ReportUndeliveredStatementFactoryXPartyByBrand.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "MONIR_UND_TESTING_BCT.PARTY_X_PRODUCT";
                    }
                ...
                if (reportType == "detail")
                {
                    ReportDataSource datasource = new ReportDataSource("DDS_US_DETAILS_Factory", dt);
                ...
                if (reportType == "summary")
                {
                    ReportDataSource datasource = new ReportDataSource("DDSUndeliveredStatementFactory", dt);
                    ReportViewer1.LocalReport.ReportPath = LocalReport.ReportPath;
                    ReportViewer1.LocalReport.DataSources.Add(datasource);
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p1, p2, p3, p4 });
                }
                ...
                if (reportType == "partyxproduct")
                {
                    ReportDataSource datasource = new ReportDataSource("DDSUndeliveredStatementFactoryXParty", dt);
                    ReportViewer1.LocalReport.ReportPath = LocalReport.ReportPath;
                    ReportViewer1.LocalReport.DataSources.Add(datasource);
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p1, p2, p3, p4 });
                }
