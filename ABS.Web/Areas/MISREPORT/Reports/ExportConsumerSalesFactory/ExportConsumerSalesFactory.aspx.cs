...
{
    public partial class ExportConsumerSalesFactory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerSalesFactory/ExportSalesStatementDetailsFactory.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_SALES";
                }
                if (reportType == "ssummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerSalesFactory/ExportSalesStatementSummaryFactory.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_SALES";
                }
