    ...
    public partial class DistributorPrimaryTarget : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string isBrndGroup = queryStrings[9];
                string brndGroupId = queryStrings[10];
                ...
                objCmd.CommandText = "Primary_SalesTarget_VS_Achievement.TargetVSLifting_New";
                          
                if (reporttype == "Detail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/PrimarySalesTarget/PrimarySalesTargetDetail.rdlc");
                }
                if (reporttype == "Summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/PrimarySalesTarget/PrimarySalesTargetSummary.rdlc");
                }
