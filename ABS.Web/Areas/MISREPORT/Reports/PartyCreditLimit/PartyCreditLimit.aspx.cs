...
{
    public partial class PartyCreditLimit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string autoId = reportActivityMonitoring.RequestStart("Party Credit Limit", reportFilteringData, Session["UserID"].ToString(), Session["UserFullName"].ToString());
             ...
             //   p2.Values.Add(reportFilter);
                ...
                LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/PartyCreditLimit/ReportPartyCreditLimit.rdlc");
                objCmd.CommandText = "REPORTS.Party_Credit_Limit";
                ...
                ReportDataSource datasource = new ReportDataSource("DSSPartyCreditLimit", dt);
