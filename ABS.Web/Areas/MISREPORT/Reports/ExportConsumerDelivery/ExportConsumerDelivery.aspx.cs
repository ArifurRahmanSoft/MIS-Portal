...
namespace ABS.Web.Areas.MISREPORT.Reports.ExportConsumerDelivery
{
    public partial class ExportConsumerDelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerDelivery/ReportDeliveryStatementCustomerWiseDetials.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_DELI_NEW";
                }
                if (reportType == "sku")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerDelivery/ReportDeliveryStatementSKUWise.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_DELI_NEW";
                }
