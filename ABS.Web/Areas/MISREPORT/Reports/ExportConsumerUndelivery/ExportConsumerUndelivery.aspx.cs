...
{
    public partial class ExportConsumerUndelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerUndelivery/ReportUSDetails.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_UNDELI";
                }
                if (reportType == "summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/ExportConsumerUndelivery/ReportUndeliveredStatementSummary.rdlc");
                    objCmd.CommandText = "PKG_RPT_EXPORT.EXPORT_CONSU_UNDELI";
                }
