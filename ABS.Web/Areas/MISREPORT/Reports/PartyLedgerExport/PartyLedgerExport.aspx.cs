...
namespace ABS.Web.Areas.MISREPORT.Reports.PartyLedgerExport
{
    public partial class PartyLedgerExport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if(reporttype == "1")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/PartyLedgerExport/PartyLedger.rdlc");
                }
                if (reporttype == "2")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/PartyLedgerExport/PartyLedgerDetail.rdlc");
                }

                objCmd.CommandText = "Rpt_Sales_Party_Ledger.GetdataExport";
