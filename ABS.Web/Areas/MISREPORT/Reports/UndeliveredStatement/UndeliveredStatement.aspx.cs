...
{
    public partial class UndeliveredStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "detail")
                {
                    ...
                    objCmd.CommandText = "UNDELIVERED_STATEMENT.summary_detail";
                    //}
                }
                ...
                if (reportType == "partyxproduct")
                {
                    ...
                    //else
                    //{
                    objCmd.CommandText = "UNDELIVERED_STATEMENT.PARTY_X_PRODUCT";
                    //}
                }
                ...
                if (reportType == "areasummary")
                {
                    ...
                    //else
                    //{
                    objCmd.CommandText = "UNDELIVERED_STATEMENT.UNDELI_AREA_WIESE";
                    //}
                }
                ...
                if (reportType == "areadetailnew")
                {
                    ...
                    //else
                    //{
                    objCmd.CommandText = "UNDELIVERED_STATEMENT.UNDELI_AREA_WIESE_NEW";
                    //}
                }
