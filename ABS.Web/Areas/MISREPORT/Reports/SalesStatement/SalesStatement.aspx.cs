        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "details_sales_statement")
                {
                    ...
                    objCmd.CommandText = "pack_sales_state_new.SALES_STATEMENT";
                    //}
                }
                ...
                if (reportType == "item_wise_summary")
                {
                    ...
                    //else
                    //{
                    objCmd.CommandText = "pack_sales_state_new.sales_statement_item_wise_summary";
                    //}
                }
                ...
                if (reportType == "Sales_Statement_Ton")
                {
                    ...
                    //else
                    //{
                    objCmd.CommandText = "pack_sales_state_new.SALES_STATEMENT_WITH_TON";
                    //}
                }
