    ...
    public partial class MonthwiseSalesDelivery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (reportType == "mwsvd")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/MonthwiseSalesDelivery.rdlc");
                    objCmd.CommandText = "REPORTS.SalesDeliveryMonthWise";
                }
                if (reportType == "DO_CHALLAN_CHECK_IN_HAND_BALANCE")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/DoChallCheckInHandBalRDLC.rdlc");
                    objCmd.CommandText = "DAILY_SALES_SUMMARY.DO_CHAL_CHEC_IN_HAN_BAL";
                }

                if (reportType == "customer_wise_m_ton")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/CustomerWiseMTonRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }

                if (reportType == "area_wise_value")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/AreaWiseValueRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }

                if (reportType == "customer_wise_ctn_bag")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/CustomerWiseCtnBagRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }
                if (reportType == "area_wise_m_ton")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/AreaWiseMTonRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }
                if (reportType == "area_wise_ctn_bag")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/AreaWiseCtnBagRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }
                if (reportType == "customer_wise_amount")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/MonthwiseSalesDelivery/CustomerWiseAmountRDLC.rdlc");
                    objCmd.CommandText = "SALES_VARIATIONS.Month_Wise_Sales";
                }
