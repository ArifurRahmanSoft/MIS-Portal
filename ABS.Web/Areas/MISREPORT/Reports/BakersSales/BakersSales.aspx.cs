...
{
    public partial class BakersSales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/BakersSales/BakersSalesDetails.rdlc");
                    objCmd.CommandText = "BAKERS_SAL_DEL_UNDEL.BAKERS_SALES";
                }
                if (reportType == "ssummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/BakersSales/BakersSalesSummary.rdlc");
                    objCmd.CommandText = "BAKERS_SAL_DEL_UNDEL.BAKERS_SALES";
                }
          ...
          //    objCmd.Parameters.Add("transportID", OracleDbType.Varchar2).Value = transportID;
                ...
                ReportDataSource datasource = new ReportDataSource("BakersSales", dt);
