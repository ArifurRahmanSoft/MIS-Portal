...
namespace ABS.Web.Areas.MISREPORT.Reports.SalesCollection
{
    public partial class SalesCollection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/SaleVsCollection/SalesVsCollectionReport.rdlc");
                }
                else
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/SaleVsCollection/SalesVsCollectionSummary.rdlc");
                }

                objCmd.CommandText = "PKG_SalesVsCollection.Sales_Vs_Collection";
