...
namespace ABS.Web.Areas.MISREPORT.Reports.RupshiFoodsSales
{
    public partial class RupshiFoodsSales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // activity monitoring
                string reportFilteringData = distributorId + "-" + productID + "-" + transportID + "-" + requistionNo + "-" + company + "-" + loggeduser + "-" + sardarId + "-" + locationId + "-" + sprogId + "-" + sdvntId
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsSales/RupshiFoodsSalesDetails.rdlc");
                    objCmd.CommandText = "RUP_FOOD_SAL_DEL_UNDEL.RUP_FOOD_SALES";
                }
                if (reportType == "ssummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsSales/RupshiFoodsSalesSummary.rdlc");
                    objCmd.CommandText = "RUP_FOOD_SAL_DEL_UNDEL.RUP_FOOD_SALES";
                }
                if (reportType == "detailsExtra")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/RupshiFoodsSales/RupshiFoodsSalesDetailsExtra.rdlc");
                    objCmd.CommandText = "RUP_FOOD_SAL_DEL_UNDEL.RUP_FOOD_SALES";
                }
