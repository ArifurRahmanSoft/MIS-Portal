...
{
    public partial class DeliveryStatementOwnProduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string prodComId = queryStrings[12];
                ...
                // activity monitoring
                string reportFilteringData = reportFilter + "-" + brandId + "-" + productId + "-" + company + "-" + locationID + "-" + prodComId + "-" + reportType + "-" + fromDate + "-" + toDate;
                ...
                if (prodComId == "" || prodComId == "undefined" || prodComId == "null")
                    prodComId = null;
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementCustomerWiseDetials.rdlc");
                    ...
                    {
                        objCmd.CommandText = "pack_challanDetail_ProdCom.get_challanDetail";
                    }
                }
                if (reportType == "sku_wise")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementSKUWise.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    else
                    {
                        ...
                        {
                            objCmd.CommandText = "pack_challanDetail_ProdCom.get_SKUWiseDelivery";
                        }
                        else
                        {
                            objCmd.CommandText = "pack_challanDetail_ProdCom.get_SKUWiseDelivery_FA";
                        }
                    }
                }
                if (reportType == "brand_wise")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementBrandWise.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_challanDetail_BCT.get_SKUWiseDelivery";
                    }
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementAreaSummary.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    {
                        objCmd.CommandText = "pack_challanDetail_ProdCom.DeliveryAreaWise";
                    }
                }
                if (reportType == "summaryton")
                {
                    ...
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementAreaMTonSummary.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                    ...
                    else
                    {
                        ...
                        objCmd.CommandText = "pack_challanDetail_ProdCom.DeliveryAreaWiseMTon_N";
                    }
                }
                if (reportType == "detail")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementAreaDetailNew.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_challanDetail_BCT.DeliveryAreaWise";
                    }
                ...
                if (reportType == "detailton")
                {
                    ...
                    LocalReport.ReportPath = Server.MapPath("~/Areas/MISREPORT/Reports/DeliveryStatementOwnProduct/ReportDeliveryStatementAreaMTonDetail.rdlc");
                    if (UserId == "07686") // tea - Iqbal Chowdhury
                    {
                        objCmd.CommandText = "pack_challanDetail_BCT.DeliveryAreaWiseMTon";
                    }
                ...
                objCmd.Parameters.Add("prodComId", OracleDbType.Varchar2).Value = prodComId;
                ...
                if (reportType == "sku_wise" || reportType == "brand_wise")
                {
                    ReportDataSource datasource = new ReportDataSource("DDSDeliveryStatementCustomerWiseDetails", dt);
                    ReportViewer1.LocalReport.ReportPath = LocalReport.ReportPath;
                    ReportViewer1.LocalReport.DataSources.Add(datasource);
