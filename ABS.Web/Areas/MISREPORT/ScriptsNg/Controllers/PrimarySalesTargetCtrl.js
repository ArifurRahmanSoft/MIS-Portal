app.controller('primarySalesTargetCtrl', ['$scope', '$http', '$window', 'crudService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, $http, $window, crudService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        $scope.ShowPrimarySalesTarget = function () {
            ...
            var queryStringPT = commonQueryString + ',' + $scope.ngModelBrand + ',' + isBrandGroup + ',' + brandGroupId + ',' + $scope.ReportType;
