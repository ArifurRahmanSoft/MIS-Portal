...
app.controller('TopNavigationBarCtrl', ['$scope', '$localStorage', 'sideNavService', '$rootScope', '$window', 'hostDire', function ($scope, $localStorage, sideNavService, $rootScope, $window, hostDire) {
    ...
    function loadRecords_Top(dataModuleID) {
        $.ajax({
            method: "get",
            url: hostDire + '/MISREPORT/api/MISReportLayout/GetTopMenu/' + $scope.sessionUserCompanyID + '/' + $scope.sessionLoggedUserID + '/' + $scope.sessionUserCompanyID,
            async: false,
            dataType: "json",
