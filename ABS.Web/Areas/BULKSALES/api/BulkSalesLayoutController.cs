...
namespace CTGroup.Web.Areas.BULKSALES.api
{
    [RoutePrefix("BULKSALES/api/BulkSalesLayout")]
    public class BulkSalesLayoutController : ApiController
    {
        private iMenuMgt objService = null;

        public BulkSalesLayoutController()
        {
