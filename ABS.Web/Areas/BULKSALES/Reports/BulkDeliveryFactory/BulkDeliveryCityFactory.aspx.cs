...
{
    public partial class BulkDeliveryCityFactory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // activity monitoring
                string reportFilteringData = customerID + "-" + productID + "-" + transportID + "-" + requistionNo + "-" + company + "-" + loggeduser + "-" + sardarId + "-" + locationId
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkPartyWiseDeliveryDetails.rdlc");
                }
                if (reportType == "partysummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkCustomerWisePartySummary.rdlc");
                }
                if (reportType == "details")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkCustomerWiseDelivery.rdlc");                   
                }
                if (reportType == "summary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkCustomerWiseDeliverySummary.rdlc");
                }
                if (reportType == "perioditem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryItemWisePeriod.rdlc");                 
                }
                if (reportType == "periodsummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryItemWisePeriodSummary.rdlc");                    
                }
                if (reportType == "categoryitem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeliveryCategoryItem.rdlc");                    
                }
                if (reportType == "categorysummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeliveryCategorySummary.rdlc");               
                }
                if (reportType == "pointitem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryPointWiseItem.rdlc");              
                }
                if (reportType == "pointsummary")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryPointWiseSummary.rdlc");                  
                }
                if (reportType == "dchargeitem")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryWithDeliveryChargeItem.rdlc");                   
                }
                if (reportType == "dcharge")
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkDeliveryFactory/ReportBulkDeleveryWithDeliveryCharge.rdlc");                   
                }
                if (isExport == "true")
                {
                    objCmd.CommandText = "TEST_SUMON.Bulk_Delivery_Local_Exp";
                }
                else
                {
                ...
                ReportDataSource datasource = new ReportDataSource("DSFactoryBulkDelivery", dt);
