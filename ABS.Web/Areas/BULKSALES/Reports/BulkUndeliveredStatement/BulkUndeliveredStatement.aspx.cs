...
namespace ABS.Web.Areas.BULKSALES.Reports.BulkUndeliveredStatement
{
    public partial class BulkUndeliveredStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //if (reportType == "unpdetails")
                //{
                //    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkUndeliveredStatement/ReportBulkUndeliveryStatementDetailPartyWise.rdlc");
                //    objCmd.CommandText = "rpt_bulk_undeliverd_dtl.getdata";
                //}
                //if (reportType == "unsummary")
                //{
                //    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkUndeliveredStatement/ReportBulkUndeliveryStatementSummary.rdlc");
                //    objCmd.CommandText = "rpt_bulk_undeliverdSum.getdata";
                //}
                //if (reportType == "itemdetails")
                //{
                //    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkUndeliveredStatement/ReportBulkUndeliveryStatemenItemWiseDetails.rdlc");
                //    objCmd.CommandText = "rpt_bulk_undeliverd_dtl.getdata";
                //}
                //if (reportType == "itemsummary")
                //{
                //    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkUndeliveredStatement/ReportBulkUndeliveryStatementItemWiseSummary.rdlc");
                //    objCmd.CommandText = "rpt_bulk_undeliverdSum.getdata";
                //}
