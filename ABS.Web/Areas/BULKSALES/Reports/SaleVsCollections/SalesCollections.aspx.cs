...
namespace ABS.Web.Areas.MISREPORT.Reports.SalesCollections
{
    public partial class SalesCollections : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/SaleVsCollectionS/SalesVsCollectionReport.rdlc");
                }
                else
                {
                    LocalReport.ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/SaleVsCollectionS/SalesVsCollectionSummary.rdlc");
                }

                objCmd.CommandText = "PKG_SalesVsCollection_Bulk.Sales_Vs_Collection";
                ...
                ReportDataSource datasource = new ReportDataSource("DSSalesVsCollection", dt);
