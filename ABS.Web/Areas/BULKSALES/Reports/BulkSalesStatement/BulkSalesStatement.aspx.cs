...
{
    public partial class BulkSalesStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (isExportIncluded == "true")  //////// local + export
                {
                    ...
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementDetails.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "partysummary")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementSummary.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "partytotal")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementSummaryDetails.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "Proddetails")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkProductWiseSalesStatementDetails.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "Prodsummary")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkProductWiseSalesStatementSummary.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "WithoutItem")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementItemsWithoutParty.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "WithoutSummary")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementSummaryWithoutParty.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "preioditem")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementItemWiseByPreiod.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "preiodsummary")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatemenSummaryWiseByPreiod.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                    if (reportType == "categoryitem")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkCategoryWiseSalesStatementDetails.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.getsalesstateCategory";
                    }
                    if (reportType == "partywiseitem")
                    {
                        ReportPath = Server.MapPath("~/Areas/BULKSALES/Reports/BulkSalesStatement/ReportBulkPartyWiseSalesStatementDetailsTon.rdlc");
                        objCmd.CommandText = "PKG_BULK_SALES_RPT.ConsolidatedSalesExport";
                    }
                }
                else /////////// local sales
                ...
                ReportDataSource datasource = new ReportDataSource("DSBulkSalesStatement", dt);
